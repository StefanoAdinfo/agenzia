    ...
    <div class="row g-4">
        ...
        ?>
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="thumbnail">
                        <?php if ($youtube_id): ?>
                            <div class="video-thumbnail" data-bs-toggle="modal" data-bs-target="#modal-<?php echo esc_attr($post_id); ?>">
                ...
                <!-- Modal YouTube -->
                <div class="modal fade" id="modal-<?php echo esc_attr($post_id); ?>" tabindex="-1" aria-hidden="true">
                                ...
                                <?php if ($youtube_id): ?>
                                    <div class="ratio ratio-16x9">
                                        <iframe src="https://www.youtube.com/embed/<?php echo esc_attr($youtube_id); ?>?autoplay=1&rel=0"
                                            title="YouTube video" allow="encrypted-media" allowfullscreen></iframe>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
